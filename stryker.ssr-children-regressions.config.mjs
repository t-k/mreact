...
const config = createStrykerConfig({
  ...
  mutate: [
    ...
    "packages/compiler/src/oxc-runtime-emit.ts:110-115",
    "packages/compiler/src/oxc-runtime-emit.ts:124-124",
    "packages/compiler/src/oxc-runtime-emit.ts:131-132",
    "packages/compiler/src/oxc-runtime-emit.ts:172-184",
    "packages/compiler/src/oxc-runtime-emit.ts:203-207",
    "packages/compiler/src/oxc-runtime-emit.ts:260-265",
