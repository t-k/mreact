...
| [examples/react-libraries](examples/react-libraries) | Real React-ecosystem libraries running unmodified on mreact through `.compat.tsx` boundaries: Recharts charts (SQLite-backed route handlers), a Lexical rich-text editor, and a conform + Zod form, with SPA navigation |
