...
const internalPackageVersions = {
  "@reckona/mreact-auth": "^0.0.199",
  "@reckona/mreact-devtools": "^0.0.199",
  "@reckona/mreact-forms": "^0.0.199",
  "@reckona/mreact": "^0.0.199",
  "@reckona/mreact-query": "^0.0.199",
  "@reckona/mreact-reactive-core": "^0.0.199",
  "@reckona/mreact-reactive-dom": "^0.0.199",
  "@reckona/mreact-router": "^0.0.199",
  "@reckona/mreact-test-utils": "^0.0.199",
