...
const internalPackageVersions = {
  "@reckona/mreact-auth": "^0.0.25",
  "@reckona/mreact-devtools": "^0.0.25",
  "@reckona/mreact-forms": "^0.0.25",
  "@reckona/mreact": "^0.0.25",
  "@reckona/mreact-query": "^0.0.25",
  "@reckona/mreact-reactive-core": "^0.0.25",
  "@reckona/mreact-router": "^0.0.25",
