...
async function renderOutOfOrderFragment<T>(
  ...
  sink.append(renderOutOfOrderFragmentHtml(id, fragmentSink.toString()));
...
function renderOutOfOrderFragmentHtml(id: string, html: string): string {
