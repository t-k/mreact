...
const reactDomCoverage: CoverageManifest = {
  ...
  flushSync: "covered",
  preconnect: "deferred",
  prefetchDNS: "deferred",
  preinit: "deferred",
  preinitModule: "deferred",
  preload: "deferred",
  preloadModule: "deferred",
  requestFormReset: "deferred",
  unstable_batchedUpdates: "deferred",
  useFormState: "deferred",
  useFormStatus: "deferred",
  default: "private",
  "module.exports": "private",
  version: "covered",
};
...
const reactDomServerCoverage: CoverageManifest = {
  ...
  resume: "deferred",
  resumeToPipeableStream: "deferred",
  default: "private",
  "module.exports": "private",
  version: "covered",
};
