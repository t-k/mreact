...
Standalone demo for `@reckona/mreact-virtual`. It renders a 10,000-photo gallery through `createVirtualGrid`, displays range and spacer telemetry, and keeps the DOM bounded while paging or jumping between the start and end of the dataset.
...
- `examples/unit/examples.test.ts` verifies the 10,000-photo data contract, fixed-size range projection, end jump, and return-to-top behavior without a browser.
