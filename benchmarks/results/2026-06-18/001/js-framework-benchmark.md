...
Raw JSON files are stored in `benchmarks/results/2026-06-18/001/js-framework-benchmark-results`.
Chrome trace files are stored in `benchmarks/results/2026-06-18/001/js-framework-benchmark-traces`.
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- |
| 1 | **mreact-react-compat-v0.0.172-local-keyed** | remove row | 47.2 | 4.5 | 39.9 | best | ms |

## Results

| suite | framework | case | status | metric | unit | value | script | paint | diff vs 1st |
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| js-framework-benchmark | **mreact-react-compat-v0.0.172-local-keyed** | remove row | completed | duration | ms | 47.2 | 4.5 | 39.9 | best |
