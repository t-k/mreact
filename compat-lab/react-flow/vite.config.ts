...
const reactFlowPackages = ["@xyflow/react"];
    ...
    ? [
        {
          ...
          replacement: resolve(labRoot, "use-sync-external-store-shim.ts"),
        },
        {
...
export default defineConfig({
  cacheDir: resolve(repoRoot, "node_modules/.vite/compat-lab-react-flow", runtime),
  define: {
