...
// 2. client.ts:3496-3545: which runtime groups a route emits and whether it imports or inlines
//    them, including the boundary-only route that must carry no resume walk.
// 3. client.ts:2877 and client.ts:5466-5479: the batch build opt-in and the bundler hooks that
...
export default createStrykerConfig({
  ...
  mutate: [
    ...
    "packages/router/src/client.ts:2877-2877",
    "packages/router/src/client.ts:3496-3545",
    "packages/router/src/client.ts:5466-5479",
  ],
